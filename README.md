...
The element has two attributes "thumnail" and "video". Thumbnail should be the URL for the thumbnail image (a la img src), and video should be the URL which will be placed in the src of the embed iframe. To get this src URL for the video you'll need inspect the embed code for the video provided by YouTube or Vimeo.
